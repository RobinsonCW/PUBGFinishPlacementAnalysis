...
```{r lda.datapull, results='hide', message=FALSE, include=FALSE, echo=FALSE}
...
```{r lda.lasso, results='hide', message=FALSE, include=FALSE, echo=FALSE}
...
```{r lda.train_final, results='hide', message=FALSE, include=FALSE, echo=FALSE}
...
```{r lda.assumptions.1, results='hide', message=FALSE, include=FALSE, echo=FALSE}
...
```{r lda.assumptions.2, results='hide', message=FALSE, include=FALSE, echo=FALSE}
...
```{r lda.model, results='hide', message=FALSE, include=FALSE, echo=FALSE}
...
```{r qda.model, results='hide', message=FALSE, include=FALSE, echo=FALSE}
...
```{r code.lda.datapull, message=FALSE, include=TRUE, echo=TRUE}
# Reduce variables to relevant continuous variables
train1<-train[,c(5:6,8:10,12:15,19,21:27,29:30)]
test1<-test[,c(5:6,8:10,12:15,19,21:27,29:30)]
# train2 <- train1[,c(1,4:19)]
...
```{r code.lda.lasso,  message=FALSE, include=TRUE, echo=TRUE}
...
```{r code.lda.train_final,  message=FALSE, include=TRUE, echo=TRUE}
...
```{r code.lda.assumptions.1,  message=FALSE, include=TRUE, echo=TRUE}
...
```{r code.lda.assumptions.2,  message=FALSE, include=TRUE, echo=TRUE}
...
```{r code.lda.model,  message=FALSE, include=TRUE, echo=TRUE}
...
```{r code.qda.model,  message=FALSE, include=TRUE, echo=TRUE}
